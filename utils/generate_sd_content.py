...
SYSTEM_PROMPTS = {
    ...
    "system/alarm_stopped_en.wav": ("About time. I thought you'd never wake up.", "en", None),
    ...
    "system/alarm_stopped_de.wav": ("Na endlich. Ich dachte schon, du wachst nie auf.", "de", None),
