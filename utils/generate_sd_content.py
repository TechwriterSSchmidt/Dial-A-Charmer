...
SYSTEM_PROMPTS = {
    ...
    "system/pb_timer_remaining_opt_en.wav": ("Choose 8 for timer remaining time.", "en", None),
    ...
    "system/timer_remaining_en.wav": ("Remaining timer time", "en", None),
    "system/timer_none_en.wav": ("No active timer.", "en", None),
    ...
    "system/pb_timer_remaining_opt_de.wav": ("Wähle 8 für Timer Restzeit.", "de", None),
    ...
    "system/timer_remaining_de.wav": ("Restzeit des Timers", "de", None),
    "system/timer_none_de.wav": ("Kein Timer aktiv.", "de", None),
